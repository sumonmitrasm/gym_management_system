					...
					<div class="page-login">
						...
						<div class="account-border">
							<div class="row">
								...
								<form name='loginform' action="admin/controller/CustomerController.php" method="post" enctype="multipart/form-data" onSubmit="return check(this)">
								...
								<div class="col-sm-6 new-customer">
									<div class="well">
										<h2><i class="fa fa-file-o" aria-hidden="true"></i>Management Login</h2>
										<p>Hare COULD BE LOGIN ADMIN,TRAINER, STAFF AND MEMBER</p>
									</div>
									<div class="bottom-form">
										<a href="management_login.php" class="btn btn-default pull-right">Continue</a>
									</div>
								</div>
							</div>
						</div>
