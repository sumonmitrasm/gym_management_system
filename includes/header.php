...
<div class="header-top-left form-inline  col-sm-6 col-xs-6 compact-hidden">
   <p class="p-2">Call Us: (+880) 1777 909090||<?php echo date('D-M-Y'); ?></p>
...
<ul class="top-link list-inline">
	<li class="signin"><a href="online_apply.php" style="color: #FF3333;" class="top-link-checkout" title="Sign In"><b><span>Online Apply</span></b></a></li>
...
<a href="index.php"><img src="img/demo/logo/home-3/24_Hour_Fitness_logo.png" title="Your Store" alt="Your Store"></a>
</div>
<!-- //end Logo -->
...
<li class="signin">
	<p class="close-menu"></p>
	<a href="about.php" class="menu1">About</a>
</li>
<li class="with-sub-menu hover">
	<p class="close-menu"></p>
	<a href="all_classes.php" class="clearfix menu1">
	...
	<div class="sub-menu" style="width: 40%; right: auto; display: none;">
		<div class="content" style="height: 160px; display: none;">
			<div class="row">
				<div class="col-md-6">
					<ul class="row-list">
						<li><a class="subcategory_item" href="all_classes.php">Services</a></li>
						<li><a class="subcategory_item" href="fatcalculator_Copy.php">Fitness Check</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<li class="signin">
	<p class="close-menu"></p>
	<a href="all_trainer.php" class="menu1">Trainer</a>
</li>
<li class="with-sub-menu hover">
	<p class="close-menu"></p>
	<a href="food.php" class="clearfix menu1">
	...
	<div class="sub-menu" style="width: 40%; right: auto; display: none;">
		<div class="content" style="height: 160px; display: none;">
			<div class="row">
				<div class="col-md-6">
					<ul class="row-list">
						<li><a class="subcategory_item" href="food.php">Food Details</a></li>
						<li><a class="subcategory_item" href="dait_chat.php">Diet Chart</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<li class="signin">
	<p class="close-menu"></p>
	<a href="special_offer.php" class="menu1">Special Offer</a>
</li>
<li class="signin">
	<p class="close-menu"></p>
	<a href="schedules.php" class="menu1">Schedule</a>
</li>
<li class="signin">
	<p class="close-menu"></p>
	<a href="galary.php" class="menu1">Galary</a>
</li>
...
<li class="signin">
	<p class="close-menu"></p>
	<a href="membership.php" class="menu1">Membership</a>
</li>

<li class="signin">
	<p class="close-menu"></p>
	<a href="contact.php" class="menu1">Contact Us</a>
</li>
<!--
<li class="with-sub-menu hover">
	<p class="close-menu"></p>
...
<a href="product.php"> <img src="admin/uploads/product/<?=$cart['image']?>" style="width:70px" alt="<?=$cart['name']?>" title="<?=$cart['name']?>" class="preview"> </a>
</td>
...
<td class="text-right" id="cart-total"><?=$total?></td>
</tr>
</tbody>
</table>
