...
<html lang="en">
<head>
<title>Gym Management System:: All ServicesS</title>
<meta charset="utf-8">
	...
	<div id="wrapper" class="wrapper-full ">
		...
		<div class="main-container container">
			<ul class="header-main">
				<li class="home"><a href="index.php">Home  </a><i class="fa fa-angle-right" aria-hidden="true"></i></li>
				<li>Services</li>
			</ul>
			...
			<div class="row">
				...
				<!-- //end Filters -->
							...
							<div class="products-list grid">
								<?php foreach($getAvailableclasses as $value){ 
									if($value['status']==1){
									?>
									...
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												...
												<a href="all_classes_description.php?id=<?=$value['id']?>" class="product-img"><img src="admin/uploads/product/<?=$value["image"]?>" alt="<?php echo $value['name']; ?>"></a>
												<!--Sale Label-->
											</div>
										</div>
										<div class="right-block">
											<div class="caption">
												<h3><b><p style="color:#900C3F;"><?=$value['name']?></p></b></h3>
												<hr>
												<h4><b><p align="justify" style="color:#3F3B3B;"> Duration: <br><?=$value['duration']?></p></b></h4>
												<hr>
												<h4><p align="justify">Training Cost: <br>TK.<?=$value['price']?></p></h4>		
											</div>
										</div><!-- right block -->
									</div>
								</div>
