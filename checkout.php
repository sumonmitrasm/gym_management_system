			...
			<div class="panel-body">
				<fieldset id="account">
					<div class="form-group required">
						...
						<input type="text" class="form-control" id="input-ship-name" placeholder="Shipping Name" value="" name="ship_name" required>
					</div>
					<div class="form-group required">
						<label for="input-ship-mobile" class="control-label">Mobile</label>
						<input type="text" class="form-control" id="input-ship-mobile" placeholder="Shipping Mobile" value="" name="ship_mobile" required>
					</div>
			...
			<div class="panel-body">
				<fieldset id="address" class="required">
					...
					<div class="form-group required">
						...
						<input type="text" class="form-control" id="input-ship-address" placeholder="Address" value="" name="ship_address" required=>
					</div>
					
					<div class="form-group required">
						<label for="input-ship-city" class="control-label">City</label>
						<input type="text" class="form-control" id="input-ship-city" placeholder="City" value="" name="ship_city" required>
					</div>
					<div class="form-group required">
						<label for="input-ship-postcode" class="control-label">Post Code</label>
						<input type="text" class="form-control" id="input-ship-postcode" placeholder="Post Code" value="" name="ship_postcode" required>
					</div>
					<div class="form-group required">
						<label for="input-ship-country" class="control-label">Country</label>
						<select class="form-control" id="input-ship-country" name="ship_country" required>
