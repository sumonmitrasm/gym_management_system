...
//print_r($categories_ids);
$new_categories_ids = implode(",", $categories_ids); // convart to string by imlode.
//echo $new_categories_ids;
//echo "</pre>";

$getProducts = $product->getProductsByCategoryIds($new_categories_ids); //for products;c5,1.21.58 min;
