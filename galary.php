	...
	<div id="wrapper" class="wrapper-full ">
		...
		<div class="main-container container">
			...
			<div class="row">
				...
				<!-- //end Filters -->
							<!--changed listings-->
							<video width="1135" height="400" controls>
		
		                           <source src="video/JAY SAAB GYM MOTIVATION _ Cinematic Gym Edit _ DMT(480P).mp4" type="video/mp4">
	                        </video>
							<div class="products-list grid">
								<?php foreach($getGalary as $value){ 
									if($value['status']==1){
									?>
