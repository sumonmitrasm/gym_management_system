...
include("admin/model/trainer.php");
$trainer = new Trainer();
			...
			<div class="row">
				...
				<!-- //end Filters -->
							...
							<div class="products-list grid">
								<?php foreach($getTrainer as $value){ 
									if($value['status']==1){
									?>
									...
									<div class="product-item-container">
										...
										<div class="left-block">
											<div class="product-image-container  second_img ">
												...
												<img src="admin/uploads/product/<?=$value["image"]?>" alt="<?php echo $value['name']; ?>" alt="John" style="width:100%">
												<!--Sale Label-->
											</div>
										</div>
										<div class="right-block">
											<div class="caption">
												<h1><?=$value['name']?></h1>
												<hr>
												<p class="title">Exprience:<?=$value['experience_label']?></p>
												<hr>
												<p><button><p>Email: <br><?=$value['email']?></button></p>		
											</div>
										</div><!-- right block -->
									</div>
								</div>
