...
<html lang="en">
<head>
<title>Gym Management System:: ALL CLASSES</title>
<meta charset="utf-8">
	...
	<div id="wrapper" class="wrapper-full ">
		...
		<div class="main-container container">
			<ul class="header-main">
				...
				<li class="home"><a href="all_classes.php">All class   </a><i class="fa fa-angle-right" aria-hidden="true"></i></li>
				<li>Discription</li>
			</ul>
								...
								<div class="product-layout">
									<div class="product-item-container">
										<div class="right-block">
											<div class="caption">
												<h3><b><p style="color: #FF9633;"><?=$getAvailableclasses['name']?></p></b></h3>
												<h4><p align="justify"><?=$getAvailableclasses['description']?></p></h4>
												<hr>	
											</div>
										</div><!-- right block -->
									</div>
