                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-header-title">
                                    <h4 class="pull-left page-title">Offer</h4>
                                    <ol class="breadcrumb pull-right">
                                        <li><a href="#">eStore</a></li>
                                        <li><a href="offer_list.php">See offer List</a></li>
                                        <li class="active">Offer Entry</li>
                                    </ol>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><h3 class="panel-title">Add Offer</h3></div>
                    ...
                    <form class="form-horizontal" action="controller/SpecialofferController.php" role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="file" name="image" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="lassprice" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                  ...
                                  <input type="hidden" name="action" value="save_specialoffers">
