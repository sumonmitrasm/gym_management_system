...
$getCertificates = $certificate->getCertificates();
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img width="100" height="70" src="uploads/product/<?=$certificate['image'];?>"></td>
                <td><?=$certificate['crsname'];?></td>
                <td><?=$certificate['year'];?></td>
                <td><?=$certificate['sdate'];?></td>
                <td><?=$certificate['edate'];?></td>
                <td><?=$certificate['issuedate'];?></td>
                <td><?=$certificate['status'] ? 'Complete' : 'Incomplete';?></td>



                <td><a href="update_certificate.php?id=<?php echo $certificate['id']; ?>" class="btn btn-info btn-sm">UPDATE</a>

                        <form action="controller/CertificateController.php" method="post" style="display:inline-block">
                    ...
                    <a href="certificate_sheet.php?id=<?php echo $certificate['id']; ?>" class="btn btn-success btn-sm">Certificate</a>
                 </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
