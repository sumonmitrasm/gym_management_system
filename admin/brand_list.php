                            ...
                            <div class="col-md-12">
                                ...
                                <?php foreach($getBrands as $key=>$brand): ?>
                                        <tr>
                                            ...
                                            <td><img src="uploads/brand/<?php echo $brand['logo']; ?>" width="100" height="70"/></td>
                                            <td><?php echo $brand['status'] ? "Active" : "Inactive"?></td>
                                            <td><a href="update_brand.php?id=<?php echo $brand['id']; ?>" class="btn btn-info btn-sm">UPDATE</a> 
											
											
											
											
											<form action="controller/BrandController.php" method="post" style="display:inline-block">
