                ...
                <div class="content">
                    ...
                    <form class="form-horizontal" action="controller/ScheduleController.php" role="form" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="fname" id="name" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Morning Time</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="fmtime" id="roll" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">First Tranner</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="ftranner" id="email"  value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">First Batch</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="fbatch" id="email"  value="" required>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="sname" id="name" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Medel Morng Time</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="smtime" id="roll" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Secound Tranner</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="stranner" id="email"  value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Secound Batch</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="sbatch" id="email"  value="" required>
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="tname" id="name" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Evening Time</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="tmtime" id="roll" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Third Tranner</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="ttranner" id="email"  value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label"> Thied Batch</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="tbatch" id="email"  value="" required>
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="ffname" id="name" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Late Evening Time</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="ffmtime" id="roll" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Fourth Tranner</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="fftranner" id="email"  value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Fourth Batch</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="ffbatch" id="email"  value="" required>
                                                </div>
                                            </div>
                                            <br>
                                  ...
                                  <input type="hidden" name="action" value="save_schecdule">
