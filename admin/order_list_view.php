                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
            <?php foreach($getOrderDetails as $key=>$value): ?>
                    <tr>
					    
                        <td value="<?php echo $value['order_details_id'];?>"><?php echo $value['name'];?></td> 
                        <td value="<?php echo $value['order_id'];?>"><?php echo $value['name'];?></td> 
                        <td value="<?php echo $value['product_id'];?>"><?php echo $value['name'];?></td> 
