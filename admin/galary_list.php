                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
            <?php foreach($getGalary as $key=>$value): ?>
                    <tr>
					    <td><?php echo $key + 1; ?></td>
                        <td><img width="100" height="70" src="uploads/product/<?php echo $value['image']; ?>" /> </td>
                        <td><?php echo $value['status'] ? 'Active' : 'Inactive' ; ?></td>
                        
                        <td>
						<a href="update_galary.php?id=<?=$value['id'] ?>" class="btn btn-info btn-sm">UPDATE</a>


						<form action="controller/GalaryController.php" method="post" style="display:inline-block">
						
						<input type="hidden" name="action" value="delete_galary" />
