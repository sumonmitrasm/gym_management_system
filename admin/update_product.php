    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
                            ...
                            <div class="col-sm-12">
                                <div class="page-header-title">
                                    ...
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li><a href="product_list.php">See Product List</a></li>
            ...
            <option value="<?php echo $brand['id'];?>" <?php if($getProduct['brand_id']==$brand['id']) echo "selected"; ?>><?php echo $brand['name'];?></option> 
                                    ...
                                    <br><img src="uploads/product/<?=$getProduct['image']?>" width="100" height ="70"alt="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                            <input type="radio" name="is_feature" value="1"<?php if($getProduct['is_feature']==1) echo "checked"; ?>> Yes 
