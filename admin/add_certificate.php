                ...
                <div class="content">
                            ...
                            <div class="col-sm-12">
                                <div class="page-header-title">
                                    ...
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li><a href="certificate_list.php">See Certificate List</a></li>
                                        <li class="active">Certificate Entry</li>
                                    </ol>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    <div class="panel-heading"><h3 class="panel-title">Add Certificte</div>
                    ...
                    <form class="form-horizontal" action="controller/CertificateController.php" role="form" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="crsname" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="sdate" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">End Date</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="edate" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">Issue Date</label>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" name="issuedate" value="" required>
                                                </div>
                                            </div>
